...
TOOL_FILTER_KEYWORDS: dict[str, list[str]] = {
    ...
    "open_url": ["url", "website", "http", "www", "site", "github", "google"],
    ...
    "open_whatsapp": ["whatsapp", "whats app", "व्हाट्सएप"],
    "send_whatsapp_message": [
        "whatsapp", "message", "send message", "text", "व्हाट्सएप", "message bhejo",
    ],
    ...
    "move_path": ["move"],
    "copy_path": ["copy"],
    "open_folder": ["open folder", "open directory", "downloads", "documents", "desktop"],
    "restart_application": ["restart chrome", "restart vscode", "restart app"],
